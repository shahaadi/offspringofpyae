...
class Node:
    ...
    def __init__(self, ID, neighbors, descriptor, weights, truth=None, file_path=None):
        """
        Parameters
        ----------
        ID : int
    ...
    def parameters(self):
        ...
        This can be accessed as an attribute, via `node.parameters` 
